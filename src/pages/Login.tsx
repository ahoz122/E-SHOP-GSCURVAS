...
const Login = () => {
  ...
  const { signIn, signInWithGoogle, error: storeError, clearError } = useAuthStore();
  ...
  const getErrorMessage = (error: FirebaseError) => {
    switch (error.code) {
      case 'auth/operation-not-allowed':
        return 'El inicio de sesión con Google no está habilitado. Por favor, contacta al administrador.';
      case 'auth/popup-closed-by-user':
        return 'Se cerró la ventana de inicio de sesión. Por favor, intenta de nuevo.';
      ...
      case 'auth/user-disabled':
        return 'Esta cuenta ha sido deshabilitada. Por favor, contacta al administrador.';
        ...
        >
          ...
          <div className="flex flex-col space-y-2">
            ...
            <motion.a
              variants={itemVariants}
              href="#"
              className="text-sm text-center text-pink-600 hover:text-pink-500 transition-colors"
            >
